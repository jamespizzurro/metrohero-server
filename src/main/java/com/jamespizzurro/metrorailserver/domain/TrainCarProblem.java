...
@Entity
@Table(name = "train_car_problem_tweet",
        indexes = {
                @Index(name = "train_car_problem_tweet_twitter_id_index", columnList = "twitter_id"),
                @Index(name = "train_car_problem_tweet_date_index", columnList = "date")
        }
)
public class TrainCarProblem {
    ...
    public TrainCarProblem() {

    }

    public TrainCarProblem(Long twitterId, String text, Calendar date, Set<String> lineCodes, String trainCarId, Set<String> keywords, Long userId, String userName) {
    ...
    public void setTrainCarId(String trainCarId) {
        this.trainCarId = trainCarId;
    }
