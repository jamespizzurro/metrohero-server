...
import com.jamespizzurro.metrorailserver.domain.StationProblem;
...
@Repository
public interface StationProblemRepository extends CrudRepository<StationProblem, Long> {

    List<StationProblem> findAllByDateGreaterThanEqualOrderByDateDesc(Calendar cutoff);
